 ...
 id="cbp-spmenu-s1">
	<div class="scrollbar scrollbar1">
		<ul class="nav" id="side-menu">
			...
			<li>
				<a href="#">
					<i class="fa fa-book nav_icon"></i>Quản lý dữ liệu
					<span class="fa arrow"></span>
				</a>
				<ul class="nav nav-second-level collapse">
					<li>
			...
			<li>
				<a href="widgets.html">
					<i class="fa fa-th-large nav_icon"></i>Widgets</a>
			</li>
			...
			<li>
				<a href="maps.html">
					<i class="fa fa-location-arrow nav_icon"></i>Maps</a>
			</li>
			<li>
				<a href="#">
					<i class="fa fa-file-text-o nav_icon"></i>Pages
					<span class="fa arrow"></span>
				</a>
				<ul class="nav nav-second-level collapse">
					<li>
			...
			<li>
				<a href="charts.html" class="chart-nav">
					<i class="fa fa-bar-chart nav_icon"></i>Charts</a>
			</li>
			<li>
				<a href="#" class="chart-nav">
					<i class="fa fa-list-ul nav_icon"></i>Extras
					<span class="fa arrow"></span>
				</a>
				<ul class="nav nav-second-level collapse">
					<li>
