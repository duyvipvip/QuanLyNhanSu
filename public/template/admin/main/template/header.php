<div class="sticky-header header-section ">
	<div class="header-left">
		<!--logo -->
		<div class="logo">
			<a href="index.php?module=admin&controller=quanlytrangchu&action=index">
				<ul>
					<li>
			...
			<ul>
				<li class="dropdown profile_details_drop">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
						<div class="profile_img">
							<span class="prfil-img">
								<img src="<?php echo Session::get('nguoidung')->hinhanh;?>" alt=""> 
								<span class="name"><?php echo Session::get('nguoidung')->tendangnhap; ?></span>
							</span>
							<div class="clearfix"></div>
						</div>
					</a>
					<ul class="dropdown-menu drp-mnu">
						...
						<li>
							<a href="<?php echo url::createLink('admin', 'dangnhap', 'logout'); ?>">
